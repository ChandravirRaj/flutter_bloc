    ...
    pdf.addPage(
      pw.Page(
        ...
        build: (pw.Context context) {
          ...
          const itemHeight = 150.0; // Fixed height for all items

          return pw.Align(
            alignment: pw.Alignment.topCenter,
            // Align content to the top-center
            child: pw.Wrap(
              ...
              children: images.asMap().entries.map((entry) {
                ...
                // Define the layout: Full-width for first/last items, half-width for others
                final isFullWidth = index == 0 || index == images.length - 1;
                ...
                return pw.Container(
                  ...
                  child: pw.Image(
                    pdfImage,
                    fit:
                    pw.BoxFit.contain, // Ensures the image is fully visible
                  ),
                );
              }).toList(),
            ),
